...
def check_status(ret, token_file=None):
...
def get_metadata(ds):
    ...
    Returns:
        dict: JSON decoded result of the query.
    """
    url = Defaults.BASE_URL + 'metadata/'
    url += ds
...
def get_param_summary(ds):
    ...
    Returns:
        dict: JSON decoded result of the query.
    """
    url = Defaults.BASE_URL + 'paramsummary/'
    url += ds
...
def submit_json(json_file, token_file=None):
...
def submit(control_file_name, token_file=None):
    ...
    return submit_json(_dict, token_file)


def get_status(request_idx=None, token_file=None):
...
def get_filelist(request_idx):
    ...
    Returns:
        dict: JSON decoded result of the query.
    """
    url = Defaults.BASE_URL + 'get_req_files/'
    url += str(request_idx)
...
def get_control_file_template(ds):
    ...
    Returns:
        dict: JSON decoded result of the query.
    """
    url = Defaults.BASE_URL + 'control_file_template/'
    url += ds
