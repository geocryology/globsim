...
class MERRApl_asm(MERRAgeneric):
    ...
    def getlatLon (out_variable, p1, p2, p3, p4, id_lat, id_lon):
        ...
        time2 = MERRAgeneric().latLon(p1, p2, p3, p4, out_variable_3dmasm, id_lat, id_lon)
        
        return time2
        

class saveNCDF_pl(MERRApl_ana, MERRApl_asm):        # for saving abstracted pressure-levels variables
        ...
        def saveData(t, v, u, h, rh, time1, time2, lev, lat, lon):
