...
# For obtaining the selected variables from MERRA-2 by conducting merra-2.py, please follow the steps as following: 
  ...
  - In project_merra.globsim_download:  
    ...
    7. To set up the wanted variables by giving a list of standard names in the Table as following:
        
       Standard Names	                                         Names in MERRA-2 Database
       air_temperature                                                      T
       eastward_wind                                                        U
       northward_wind                                                       V
       geopotential_height                                                  H
       relative_humidity                                                    RH
       2-meter_air_temperature                                              T2M
       ...
       surface_net_downward_shortwave_flux                                  SWGNT
...
2. Update and extend the list of Standard Names if it is needed. 

4. Reference the CF Standard Names at: 
...
3. For obtaining single variable, to set up the standard name of variable with ‘,’ in the end
